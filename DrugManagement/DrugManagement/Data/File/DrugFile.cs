        ...
        public override void Read()
        {
            ...
            if (Element != null)
            {
                ...
                foreach (var element in Element.Elements(_ElementName))
                {
                    ...
                    drug.HourTimeEach = GetAttribute(child, nameof(Drug.HourTimeEach), drug.HourTimeEach);
                    ...
                    drug.DrugTiming = GetValue(element, nameof(Drug.DrugTiming), drug.DrugTiming);
        ...
        public override void Save()
        {
            ...
            using (var elements = new List<XElement>())
            {
                ...
                for (int iLoop = 0; iLoop < Drugs.Count; iLoop++)
                {
                    ...
                    AddAttribute(ref child, new XAttribute(nameof(Drug.HourTimeEach), drug.HourTimeEach));
                    ...
                    AddElement(ref element, new XElement(nameof(Drug.DrugTiming), drug.DrugTiming));
